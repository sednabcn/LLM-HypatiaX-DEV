...
Step IDs (use with --only / --from):
    Setup    : deps  patches-gen  patches-apply  fixup-init  fixup-tex
               validate  validate-paper-config  check-hypatiax-protocols
...
Changelog v7.1 (2026-05-08):
    SYNC-run_all.sh:
      ...
      suppB       — cmd retained as experiment_protocol_noise_sweep.py (protocol
                    wrapper still correct; run_all.sh calls same script indirectly).
