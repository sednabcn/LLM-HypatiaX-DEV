...
- INFO_MW_ALL_NOT_SIGNIFICANT: Tier-1 (all-N) Mann-Whitney one-sided p=0.0856 (two-sided p=0.1713, r=-0.3333, n=12) — directional but not significant. Expected: 21 discovery failures add noise. Report Tier-3 success-subset as primary claim. Workflow continues.
- WARN_MW_SUCCESS_NOT_SIGNIFICANT: Tier-3 (success-subset) Mann-Whitney one-sided p=0.0856 (n=12) — not significant at α=0.05. Primary paper claim (§10.7) may be weaker than expected. Investigate.
...
**Tier 3 (success-subset, R²≥0.99):** The paper's primary claim (§10.7). Restricts to equations where HypatiaX achieved symbolic recovery. This is the publishable result — it answers whether symbolic recovery produces a qualitatively different extrapolation regime, not whether HypatiaX always wins.
  ...
  Tier 1 — All-N: U=96.0, p_one=0.0856, p_two=0.1713, n=12, r=-0.3333
  Tier 2 — Excl-train-fail (train R²≥0): U=96.0, p_one=0.0856, p_two=0.1713, n=12, r=-0.3333
  Tier 3 — Success-subset (extrap R²≥0.99) ★: U=96.0, p_one=0.0856, p_two=0.1713, n=12, r=-0.3333
...
|-------|---------------|-----------|------|---------|
| Tier 1 — All-N | 4 | 0 | 8 | 12 |
| Tier 2 — Excl-train-fail | 4 | 0 | 8 | 12 |
| Tier 3 — Success-subset ★ | 4 | 0 | 8 | 12 |
...
|--------|---|-------------|----------|----------|-----------|
| feynman_biology | 3 | 1 | 0.3333 | 0 | 0.0 |
...
|-----------|------------|---|-------|-------|--------------|
| -0.50 | 12 | 96.0 | 0.0856 | 0.1713 | — |
| -0.25 | 12 | 96.0 | 0.0856 | 0.1713 | — |
| +0.00 | 12 | 96.0 | 0.0856 | 0.1713 | — |
| +0.10 | 12 | 96.0 | 0.0856 | 0.1713 | — |
| +0.25 | 12 | 96.0 | 0.0856 | 0.1713 | — |
| +0.50 | 12 | 96.0 | 0.0856 | 0.1713 | — |
...
| Arrhenius rate constant (Feynman variant) — cross-benchmark consistency check | feynman_chemistry | 0.0000 | 0.4145 | 0.5855 | no |
| Henderson-Hasselbalch equation for buffer pH | feynman_chemistry | 0.0000 | 1.0000 | 0.0000 | no |
| Nernst equation for electrode potential — cross-benchmark consistency check | feynman_electrochemistry | 0.0000 | 1.0000 | 0.0000 | no |
...
| Fermi-Dirac occupation number for fermions | feynman_quantum | 0.0000 | -27.7481 | 28.7481 | no |
