...
# Uses run_comparative_suite_benchmark_v2.py with --benchmark feynman so all
# six comparison methods run through the same protocol interface, making the
# output directly comparable with exp2 results.
...
# ── STEP 6: exp2 — Combined five-system injection ────────────────────────────
...
# ── STEP 7: exp3 — Nguyen-12 benchmark, SEED=42 ──────────────────────────────
...
# ── STEP 8: exp3b — Nguyen-12 stability seeds ───────────────────────────────
...
# ── STEP 9: suppA — DeFi routing improvements ───────────────────────────────
...
# ── STEP 10: suppB — Noise sweep + sample complexity ─────────────────────────
...
# ── STEP 11: tables — Generate all LaTeX tables ───────────────────────────────
...
# ── STEP 12: figures — Generate all paper figures ────────────────────────────
...
# ── STEP 13: validate — Cross-check results ───────────────────────────────────
