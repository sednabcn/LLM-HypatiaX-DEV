...
%% \proof/\endproof too, which is a fatal clash. Clear jmlr2e's
%% version first so amsthm can load cleanly.
\let\proof\relax
\let\endproof\relax
\usepackage{amsthm}
%% Guard against jmlr2e already claiming `example` too (same class of
%% clash as the \proof and \theorem issues in jmlr_paper_main.tex).
\makeatletter
