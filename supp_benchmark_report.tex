...
($\Rsq > 0.9999$). \HDS{} achieves 90.0\% (27/30 equations) under the same
noiseless protocol.
...
\midrule
0\%   & 100.0\%           & 0 & 100.0\%$^\ddagger$ & 0\\
0.5\% & 100.0\%          & 0 & 100.0\% & 0\\
1\%   & 100.0\%          & 0 & 100.0\% & 0\\
5\%   & 100.0\%          & 0 & 100.0\% & 0\\
10\%  & 100.0\%          & 0 & 100.0\% & 0\\
\bottomrule
\multicolumn{5}{l}{\footnotesize$^\ddagger$ M4 noiseless: 100\% (v2-corrected) at threshold 0.999999.}\\
...
\begin{enumerate}
  ...
  \item \textbf{Both M3 and M4 reach 100\% at $\sigma=0$} (noiseless,
    v2-corrected); \HDS{} (M6, tools track) trails at 90\% (27/30), with
    three near-miss equations (Lorentz force, Photon energy, Zeeman energy).
    \textbf{[Correction, Phase~3 audit: this item previously attributed
    \HDS's 90\% figure and its three near-misses to M4/\HSL; corrected here
    --- see Item~2a in the companion Bug Recovery History report.]}
...
Findings and Bug Recovery History} (\S\ref{sec:findings:item10b}) for the
