...
Analytical Discovery} (\texttt{jmlr_paper_main.tex}).
...
The main paper (\texttt{jmlr_paper_main.tex}) now reports v3.0
...
Table~\ref{tab:nguyen12} provides this comparison.
...
\begin{itemize}
\item \textbf{Interpolation}: $R^2 = 0.21$ (poor fit; relative error $> 100\%$, meeting the threshold in Definition~\ref{def:decoupling})
