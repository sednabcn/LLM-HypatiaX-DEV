...
|--------|---|-----------------|----------|----------------|--------------|
| Pure LLM | 74 | 78.4% | 82.8% | 1.0000 | -0.3169 |
| Neural Net | 74 | 87.8% | 20.0% | -0.2412 | -1.0903 |
| Hybrid | 74 | 100.0% | 90.5% | 1.0000 | 0.7666 |
...
### Hybrid vs Pure LLM
  ...
  U=2385.5,  p=0.0913,  direction=b_greater,  n=(74, 58)

### Hybrid vs Neural Net

  U=4590.5,  p=0.0000**,  direction=a_greater,  n=(74, 65)

### Neural Net vs Pure LLM

  U=539.0,  p=0.0000**,  direction=b_greater,  n=(65, 58)
_** = p < 0.05_
...
| Options Delta | medium | norm_cdf | N/A | N/A | -10.3199 | -10.3199 |
| Optimal LP Position (Kelly) | medium | rational | N/A | N/A | 0.0000 | 0.0000 |
| Black-Scholes Call Price | hard | norm_cdf | N/A | N/A | -1.0375 | -1.0375 |
| Black-Scholes Put Price | hard | norm_cdf | 0.5415 | 0.5415 | 0.0277 | 0.5415 |
...
| Liquidation price for leveraged short | hard | rational | N/A | N/A | -1.4327 | 1.0000 |
...
| norm_cdf | 3 | 0.5415 | -1.0375 | -1.0375 |
| norm_pdf | 3 | 0.5695 | 0.3433 | 0.3433 |
| piecewise_linear | 1 | 1.0000 | 0.8679 | 1.0000 |
| quadratic_form | 3 | 1.0000 | -0.2542 | 1.0000 |
| rational | 24 | 1.0000 | -0.0229 | 1.0000 |
| rational_simple | 7 | 1.0000 | 0.5461 | 1.0000 |
| weighted_aggregate | 1 | -10.0000 | 0.9709 | 1.0000 |

## Extrapolation Gap (train R² − test R²)

| Method | Mean gap | Median gap | N |
|--------|----------|------------|---|
| Pure LLM | 9020.8316 | 0.0000 | 58 |
| Neural Net | 2.0916 | 1.2411 | 65 |
| Hybrid | -0.0173 | 0.0000 | 74 |

## Wall-clock Timing (standard equations)

| Method | Mean (s) | Median (s) | Total (s) | N |
|--------|----------|------------|-----------|---|
| Pure LLM | 11.0606 | 9.9630 | 818.49 | 74 |
| Neural Net | 0.3442 | 0.3870 | 25.47 | 74 |
| Hybrid | 1.8350 | 1.3855 | 135.79 | 74 |
