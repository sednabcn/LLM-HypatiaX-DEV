...
def _formula_has_pathological_behavior(code: str) -> bool:
    """
    FIX 10: Detect formulas with patterns known to cause degenerate output.
...
def _get_test_cases() -> List[Dict]:
    ...
    return [
        ...
        {"name": "Funding rate cost",             "domain": "trading",     "difficulty": "medium", "formula_type": "rational",        "num_samples": 200, "config": {"split_var_idx": 0, "split_type": "high"}},
        ...
        {"name": "Concentrated liquidity position width", "domain": "liquidity", "difficulty": "medium", "formula_type": "algebraic_with_sqrt", "num_samples": 200, "config": {"split_var_idx": 0, "split_type": "high"}},
        ...
        {"name": "Constant product formula",         "domain": "amm",         "difficulty": "hard",   "formula_type": "rational",        "num_samples": 200, "config": {"split_var_idx": 0, "split_type": "high"}},
